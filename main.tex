...
removes the possibility of using optimization build in the automatic
differentiation.
...
%TODO:Add description of future work.
\end{document}
...
\begin{tabular}{|c|c c c c|}
	\hline
	\(D_{i}\) / MM5x5 & Primal & RMAD   & PPAD-C & PPAD-F \\
	\hline
	\(10^{7}\)        & 7616   & 33828  & 170336 & 45008  \\
	\(10^{8}\)        & 37626  & 167955 & 848794 & 223939 \\
	\hline
\end{tabular}
\begin{tabular}{|c|c|c|c|c|}
	\(D_{i}\) / MM5x5 & Primal & RMAD  & PPAD-C & PPAD-F \\
	...
	\(D_{1}\)         & 960    & 6566  & 8263   & 6198   \\
	\(D_{1}\)         & 8986   & 64790 & 81734  & 61005
\end{tabular}
...
\begin{tabular}{|c|c|c|c|c|}
	...
	\(D_{1}\)         & 370    & 1552  & 2086   & 1579   \\
	\(D_{2}\)         & 3360   & 15019 & 20264  & 15101
\end{tabular}
\caption{Matrix Multiplication 2x2}
\begin{tabular}{|c|c|c|c|c|}
	          & Primal & RMAD & PPAD-C & PPAD-F \\
	\hline

	\(D_{1}\) & 188    & 614  & 750    & 746    \\
	\(D_{2}\) & 1552   & 5637 & 6984   & 6698
\end{tabular}
...
\begin{tabular}{|c|c|c|c|c|}
	...
	\(D_{1}\) & 190    & 773  & 641    & 631    \\
	\(D_{2}\) & 1560   & 7228 & 5919   & 5647
\end{tabular}
...
\begin{tabular}{|c|c|c|c|c|}
	...
	\(D_{1}\) & 369    & 2370  & 2744   & 1531   \\
	\(D_{2}\) & 3248   & 23046 & 26746  & 14510
\end{tabular}
...
\begin{tabular}{|c|c|c|c|c|}
	...
	\(D_{1}\) & 144    & 147  & 215    & 157    \\
	\(D_{2}\) & 784    & 1270 & 1848   & 1325
\end{tabular}
\caption{Addition}
\begin{tabular}{|c|c|c|c|c|}
	          & Primal & RMAD & PPAD-C & PPAD-F \\
...
\begin{tabular}{|c|c|c|c|c|}
	...
	\(D_{1}\) & 146    & 147  & 215    & 565    \\
	\(D_{2}\) & 1183   & 1270 & 1848   & 4866
\end{tabular}
\caption{Min}
\begin{tabular}{|c|c|c|c|c|}
	          & Primal & RMAD & PPAD-C & PPAD-F \\
	...
	\(D_{1}\) & 106    & 368  & 479    & 476    \\
	\(D_{2}\) & 783    & 3229 & 4323   & 4012
\end{tabular}
\caption{Mul}
\begin{tabular}{|c|c|c|c|c|}
	          & Primal & RMAD & PPAD-C & PPAD-F \\
